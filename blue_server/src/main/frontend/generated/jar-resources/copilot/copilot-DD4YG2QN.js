...
function No(e, t) {
  return process.env.NODE_ENV !== "production" && ct(e) && f("observable.struct should not be used with observable values"), Tn(e, t) ? t : e;
}
var xo = "override";
function kt(e) {
...
function zo(e, t, n, r) {
  var i, o;
  return Ho(e, this, t, n), e.defineObservableProperty_(t, n.value, (i = (o = this.options_) == null ? void 0 : o.enhancer) != null ? i : Ae, r);
}
function Bo(e, t) {
  if (process.env.NODE_ENV !== "production") {
    if (t.kind === "field")
  ...
  function a(l, s) {
    var c, u, d = qe(l)[p], v = new Oe(s, (c = (u = n.options_) == null ? void 0 : u.enhancer) != null ? c : Ae, process.env.NODE_ENV !== "production" ? d.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
function Ot(e) {
  return e.deep === !0 ? Ae : e.deep === !1 ? Kt : ra(e.defaultDecorator);
}
function na(e) {
  var t;
...
var ia = {
  box: function(t, n) {
    var r = wt(n);
    return new Oe(t, Ot(r), r.name, !0, r.equals);
  },
  array: function(t, n) {
    var r = wt(n);
  ...
  object: function(t, n, r) {
    return Te(function() {
      return di(h.useProxies === !1 || r?.proxy === !1 ? qe({}, r) : Ba({}, r), t, n);
    });
  },
  ref: /* @__PURE__ */ Y(Qo),
...
function ua(e) {
  Tt !== e.actionId_ && f(30), Tt = e.parentActionId_, e.error_ !== void 0 && (h.suppressReactionErrors = !0), Jt(e.prevAllowStateChanges_), nt(e.prevAllowStateReads_), L(), e.runAsAction_ && oe(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && V({
...
var ha = "create", Oe = /* @__PURE__ */ function(e) {
...
function Wr(e, t, n) {
  ...
  return h.inBatch--, h.trackingDerivation = i, pa(e), va(e), nt(r), o;
}
function va(e) {
...
Object.assign(st, mn);
ye.bound = /* @__PURE__ */ Y(Na);
st.bound = /* @__PURE__ */ Y(xa);
function Pa(e) {
...
function li(e, t, n) {
  ...
  var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction", l = ye(a, n.onError ? $a(n.onError, t) : t), s = !n.scheduler && !n.delay, c = si(n), u = !0, d = !1, v, g = n.compareStructural ? Le.structural : n.equals || Le.default, _ = new ee(a, function() {
    u || s ? w() : d || (d = !0, c(w));
...
var on = /* @__PURE__ */ Lr("flow"), Ma = /* @__PURE__ */ Lr("flow.bound", {
  ...
  var r = t, i = r.name || "<unnamed flow>", o = function() {
    var l = this, s = arguments, c = ++Ra, u = ye(i + " - runid: " + c + " - init", r).apply(l, s), d, v = void 0, g = new Promise(function(_, w) {
      var N = 0;
      d = w;
      function G($) {
        v = void 0;
...
function Ia(e, t) {
  return e ? We(e) || !!e[p] || xn(e) || jt(e) || Xt(e) : !1;
}
function ct(e) {
...
var za = {
  ...
  set: function(t, n, r) {
    var i;
    return Ee(n) ? (process.env.NODE_ENV !== "production" && !ge(t).values_.has(n) && Je("add a new observable property through direct assignment. Use 'set' from 'mobx' instead."), (i = ge(t).set_(n, r, !0)) != null ? i : !0) : !1;
  },
  deleteProperty: function(t, n) {
    var r;
    return process.env.NODE_ENV !== "production" && Je("delete properties from an observable object. Use 'remove' from 'mobx' instead."), Ee(n) ? (r = ge(t).delete_(n, !0)) != null ? r : !0 : !1;
  },
...
function Ba(e, t) {
  var n, r;
  return Cr(), e = qe(e, t), (r = (n = e[p]).proxy_) != null ? r : n.proxy_ = new Proxy(e, za);
}
function R(e) {
...
var Wa = {}, ce = "add", Mt = "delete", pi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = Ae), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + B() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[p] = Wa, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = r, this.name_ = i, A(Map) || f(18), Te(function() {
  ...
  return t.has_ = function(r) {
    ...
    if (!o) {
      var a = o = new Oe(this.has_(r), Kt, process.env.NODE_ENV !== "production" ? this.name_ + "." + hn(r) + "?" : "ObservableMap.key?", !1);
    ...
    X(this.keysAtom_), re(function() {
      var c, u = new Oe(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + hn(r) : "ObservableMap.key", !1);
    ...
    return ve(r) && (r = new Map(r)), re(function() {
      D(r) ? vo(r).forEach(function(o) {
        ...
        var a = o[0], l = o[1];
        return i.set(a, l);
      }) : Fe(r) ? (fo(r) || f(19, r), r.forEach(function(o, a) {
        return i.set(a, o);
      })) : r != null && f(20, r);
    }), this;
  }, t.clear = function() {
...
var Ja = {}, gi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = Ae), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + B() : "ObservableSet"), this.name_ = void 0, this[p] = Ja, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, A(Set) || f(22), this.enhancer_ = function(a, l) {
      return r(a, l, i);
    }, Te(function() {
...
var Qn = /* @__PURE__ */ Object.create(null), er = "remove", yn = /* @__PURE__ */ function() {
  ...
  return t.getObservablePropValue_ = function(r) {
    ...
    return i || (i = new Oe(r in this.target_, Kt, process.env.NODE_ENV !== "production" ? this.name_ + "." + hn(r) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(r, i)), i.get();
    ...
    try {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[r], c && (this.values_.delete(r), c instanceof Oe && (u = c.value_), Qr(c)), this.keysAtom_.reportChanged(), (a = this.pendingKeys_) == null || (a = a.get(r)) == null || a.set(r in this.target_), l || s) {
        var v = {
          type: er,
          observableKind: "object",
          object: this.proxy_ || this.target_,
...
function yi(e, t) {
  if (e || f(29), xn(e) || Xt(e) || jt(e) || ve(e) || J(e))
    return e;
  if (e[p])
    return e[p];
  f(24, e);
...
function jn(e) {
  import("./copilot-notification-Cnh_SAYH.js").then(({ showNotification: t }) => {
    t(e);
  });
}
function as() {
...
const xe = "copilot-", ls = "24.5.3", Ll = "attention-required", Ul = "https://plugins.jetbrains.com/plugin/23758-vaadin", zl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Bl = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, cs = (e) => {
  const t = [];
  let n = ds(e);
  for (; n; )
...
function ut(e) {
  return !e || !(e instanceof HTMLElement) ? !1 : [...cs(e), e].map((t) => t.localName).some((t) => t.startsWith(xe));
}
function Hl(e) {
...
var Ai = /* @__PURE__ */ ((e) => (e["vaadin-combo-box"] = "vaadin-combo-box", e["vaadin-date-picker"] = "vaadin-date-picker", e["vaadin-dialog"] = "vaadin-dialog", e["vaadin-multi-select-combo-box"] = "vaadin-multi-select-combo-box", e["vaadin-select"] = "vaadin-select", e["vaadin-time-picker"] = "vaadin-time-picker", e["vaadin-popover"] = "vaadin-popover", e))(Ai || {});
const Xe = {
  "vaadin-combo-box": {
    hideOnActivation: !0,
    open: (e) => Et(e),
...
class hs {
  ...
  overlayStatus(t) {
    if (!t)
      return { visible: !1 };
    const n = t.localName;
    let r = Object.keys(Ai).includes(n);
    if (!r)
      return { visible: !1 };
...
window.Vaadin.copilot._uiState = new ss();
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ws, defineProperty: Os, getOwnPropertyDescriptor: Es, getOwnPropertyNames: As, getOwnPropertySymbols: Ss, getPrototypeOf: Ns } = Object, Qt = globalThis, dr = Qt.trustedTypes, xs = dr ? dr.emptyScript : "", Ps = Qt.reactiveElementPolyfillSupport, rt = (e, t) => e, On = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? xs : null;
      break;
...
class Re extends HTMLElement {
  ...
  static createProperty(t, n = hr) {
    if (n.state && (n.attribute = !1), this._$Ei(), this.elementProperties.set(t, n), !n.noAccessor) {
      ...
      i !== void 0 && Os(this.prototype, t, i);
    }
  }
  static getPropertyDescriptor(t, n, r) {
    const { get: i, set: o } = Es(this.prototype, t) ?? { get() {
      return this[n];
    }, set(a) {
      this[n] = a;
    } };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const In = globalThis, Lt = In.trustedTypes, vr = Lt ? Lt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Ln = "$lit$", ie = `lit$${Math.random().toFixed(9).slice(2)}$`, Un = "?" + ie, Cs = `<${Un}>`, De = document, dt = () => De.createComment(""), ht = (e) => e === null || typeof e != "object" && typeof e != "function", zn = Array.isArray, ki = (e) => zn(e) || typeof e?.[Symbol.iterator] == "function", ln = `[ 	
\f\r]`, Ze = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pr = /-->/g, gr = />/g, be = RegExp(`>|${ln}(?:([^\\s"'>=/]+)(${ln}*=${ln}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), br = /'/g, _r = /"/g, Ti = /^(?:script|style|textarea|title)$/i, Vi = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), Ut = Vi(1), Gl = Vi(2), he = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), mr = /* @__PURE__ */ new WeakMap(), we = De.createTreeWalker(De, 129);
function ji(e, t) {
...
const Ri = (e, t) => {
  ...
  for (let l = 0; l < n; l++) {
    ...
    o += a === Ze ? s + Cs : d >= 0 ? (r.push(c), s.slice(0, d) + Ln + s.slice(d) + ie + g) : s + ie + (d === -2 ? l : g);
  }
...
let en = class Ii {
  ...
  _$AI(t, n = this) {
    t = $e(this, t, n), ht(t) ? t === E || t == null || t === "" ? (this._$AH !== E && this._$AR(), this._$AH = E) : t !== this._$AH && t !== he && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ki(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class yt {
  ...
  _$AI(t, n = this, r, i) {
    ...
    if (o === void 0) t = $e(this, t, n, 0), a = !ht(t) || t !== this._$AH && t !== he, a && (this._$AH = t);
      ...
      const l = t;
      let s, c;
      for (t = o[0], s = 0; s < o.length - 1; s++) c = $e(this, l[r + s], n, s), c === he && (c = this._$AH[s]), a ||= !ht(c) || c !== this._$AH[s], c === E ? t = E : t !== E && (t += (c ?? "") + o[s + 1]), this._$AH[s] = c;
    }
    a && !i && this.j(t);
  }
  j(t) {
...
const ks = { M: Ln, P: ie, A: Un, C: 1, L: Ri, R: Mi, D: ki, V: $e, I: en, H: yt, N: Ui, U: zi, B: Li, F: Bi }, Ts = In.litHtmlPolyfillSupport;
Ts?.(ft, en), (In.litHtmlVersions ??= []).push("3.2.0");
const Vs = (e, t, n) => {
...
function Is() {
  me.push(import("./copilot-log-plugin-BbZtXM8m.js")), me.push(import("./copilot-info-plugin-a_iJ8RCS.js")), me.push(import("./copilot-features-plugin-CnVpNpYQ.js")), me.push(import("./copilot-feedback-plugin-Dk_5Idwi.js")), me.push(import("./copilot-shortcuts-plugin-B2CkIPus.js"));
}
function Ls() {
  {
    const e = `https://cdn.vaadin.com/copilot/${ls}/copilot-plugins.js`;
    import(
      /* @vite-ignore */
      e
    ).catch((t) => {
...
const St = new zs(), O = window.Vaadin.copilot.eventbus;
if (!O)
...
const Bs = Fi(En), Hs = (e) => {
  He("Unspecified error", e), O.emit("vite-after-update", {});
}, Fs = (e) => e.error ? (Ks({
  error: e.error,
...
}, Js = async () => Di(`${xe}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)), Xs = async () => Ei(() => b.userInfo), Ql = async () => (await Xs()).vaadiner;
...
const { I: al } = ks, Sr = () => document.createComment(""), et = (e, t, n) => {
  ...
  return n;
}, _e = (e, t, n = e) => (e._$AI(t, n), e), sl = {}, ll = (e, t = sl) => e._$AH = t, cl = (e) => e._$AH, un = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
  ...
  return ot`
    ...
    (r) => {
      ...
      return ot` <copilot-section-panel-wrapper panelTag="${i}">
          ${Q.shouldRender(r.tag) ? ot`<${i} slot="content"></${i}>` : E}
...
let Dr = class extends Ms {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-D3wCoPsN.js"), await import("./copilot-init-step2-BdcR_mvl.js"), Is(), this.tabIndex = 0, St.hostConnectedCallback(), window.addEventListener("keydown", Er), O.onSend(this.handleSendEvent), this.removers.push(O.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
   ...
   */
  activate() {
    tn("activate"), St.activate(), Pr.copilotActivated(), Us(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), Ye.onCopilotActivation(), O.emit("component-tree-updated", {}), Xi.loadPreviewConfiguration();
  }
  /**
   * Called when Copilot is deactivated. Good place to remove listeners etc.
   */
  deactivate() {
    this.closeDrawers(), St.deactivate(), Pr.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), Ye.onCopilotDeactivation();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), St.hostDisconnectedCallback(), window.removeEventListener("keydown", Er), O.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), Ye.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
